...
- The nested `twinbuddy/AGENTS.md` is an older spec with stale `hecker/` paths and an inaccurate router-version claim; prefer this file.
...
- **Commit messages**: write them in Chinese (subject + body), keeping the English conventional-commit prefix — see the global `~/.Codex/AGENTS.md`. Branch names stay English/kebab-case.
