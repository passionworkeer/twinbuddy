...
我们为产品注入了一段情感化的叙事氛围，将以下关键词自然融入产品体验：
...
| 位置 | 融入内容 | 说明 |
|------|---------|------|
| **OnboardingPage 背景** | 20个关键词水印 | 全程引导页背景添加淡色关键词装饰，营造诗意氛围 |
| **懂你卡片（Layer3）** | 12个关键词水印 + 诗意收尾语 | 协商成功后展示，结合关键词生成5种诗意结语 |
| **BuddyCard 搭子卡片** | 基于MBTI的关键词标语 | 每个搭子展示对应的情感关键词组合 |
