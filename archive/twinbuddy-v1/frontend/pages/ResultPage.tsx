...
import { sanitizePersonaText } from '../utils/sanitize';
      ...
      <div className={`mx-auto max-w-2xl space-y-6 px-4 pt-6 transition-all duration-500 ${visible ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <div className="rounded-2xl bg-gradient-to-r from-purple-500 to-pink-500 p-6 text-center text-white shadow-xl">
          ...
          <p className="mt-2 text-lg font-bold leading-relaxed italic">
            "{sanitizePersonaText(persona.soul_fingerprint)}"
          </p>
        </div>
        ...
        {persona.mbti_influence && (
          <div className="rounded-2xl bg-blue-50 p-4 dark:bg-blue-950/30">
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300">{sanitizePersonaText(persona.mbti_influence)}</p>
          </div>
        )}
